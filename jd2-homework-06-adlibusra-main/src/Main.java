...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    List<Product> activetedProductPrice =		manager.getActiveProductsSortedByPrice();
    System.out.println("\n\nActive  2 " + activetedProductPrice);
    		
    	    System.out.println("\n\nCategory 1 AveragePrice ");
    double categoryProduct=  manager.calculateAveragePriceInCategory("Category 1");
    System.out.println(categoryProduct);
    System.out.println("\n\nCategory 2 CategoryPriceSum ");
    double categoryPriceSum=  manager.calculateAveragePriceInCategory("Category 2");
    System.out.println(categoryPriceSum);
  }
}